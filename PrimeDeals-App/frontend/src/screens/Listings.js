...
import logo from '../assets/listings/logo.png';
import { API_BASE_URL } from '../config';
import { FaBed, FaBath, FaHome, FaMapMarkerAlt, FaTag } from 'react-icons/fa';
...
function Listings() {
  ...
  const handleRentBuyClick = (listingId, purchaseType) => {
    navigate(`/details/${listingId}?purchaseType=${purchaseType}`);
  };
...
`}
      ...
      <header className="navbar">
        ...
        <nav className="navLinksContainer">
            <Link to="/listings" className="navLink">Listings</Link>
        </nav>
    </header>
        ...
        {listings.map((listing, index) => (
          <div key={index} className="listing-item">
            ...
            <div className="listing-details">
              ...
              <button className="buy-button" onClick={() => handleRentBuyClick(listing._id, 'buy')}>Buy</button>
              <p className="listing-priceRent">{listing.priceRent}</p>
              <button className="rent-button" onClick={() => handleRentBuyClick(listing._id, 'rent')}>Rent</button>
            </div>
          </div>
        ))}
      </div>
