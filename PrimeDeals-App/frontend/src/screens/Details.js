...
function Details() {
    ...
    const initialPurchaseType = searchParams.get('purchaseType') || 'buy'; // Default to buy if not specified
    ...
    const [formData, setFormData] = useState({
        ...
        lastName: "",
        email: "",
        purchaseType: initialPurchaseType, // Add purchase type (buy or rent)
        date: "",
        time: "",
    });
